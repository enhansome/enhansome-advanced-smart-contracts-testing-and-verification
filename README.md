...
* [**Echinda | Ethereum smart contract Property-based fuzzer**](https://github.com/crytic/echidna/) ⭐ 3,181 | 🐛 114 | 🌐 Haskell | 📅 2026-09-16
* [**ItyFuzz | EVM and MoveVM hybrid fuzzer that combines symbolic execution and fuzzing**](https://github.com/fuzzland/ityfuzz) ⭐ 1,115 | 🐛 63 | 🌐 Rust | 📅 2025-12-10
...
* [**Gambit | Solidity mutation system**](https://github.com/Certora/gambit) ⭐ 211 | 🐛 11 | 🌐 Rust | 📅 2026-08-12
* [**Vertigo-rs | Ethereum smart contract mutation testing framework**](https://github.com/JoranHonig/vertigo) ⭐ 209 | 🐛 17 | 🌐 Python | 📅 2023-11-21
* [**Dafny-EVM | functional specification of the Ethereum Virtual Machine in Dafny**](https://github.com/ConsenSys/evm-dafny) ⭐ 140 | 🐛 46 | 🌐 Dafny | 📅 2026-05-11
* [**Fuzz-utils | Tool for generating Foundry unit tests from smart contract fuzzer failed properties**](https://github.com/crytic/fuzz-utils) ⭐ 115 | 🐛 19 | 🌐 Solidity | 📅 2025-08-25
...
* [**@paco0x Kyber Network exploit reproduction with Fuzzing**](https://github.com/paco0x/kyber-exploit-example) ⭐ 76 | 🐛 0 | 🌐 Solidity | 📅 2023-11-27
...
* [**Public Use of Echidna**](https://github.com/crytic/echidna?tab=readme-ov-file#public-use-of-echidna) ⭐ 3,181 | 🐛 114 | 🌐 Haskell | 📅 2026-09-16
...
* [**Seaport | Discussion #809 Understanding the "DifferentialTest" test contract**](https://github.com/ProjectOpenSea/seaport/discussions/809) ⭐ 2,253 | 🐛 10 | 🌐 Solidity | 📅 2026-09-01
* [**Murky Merkle Tree DifferentialTests.t.sol**](https://github.com/dmfxyz/murky/blob/main/differential_testing/test/DifferentialTests.t.sol) ⭐ 516 | 🐛 11 | 🌐 Solidity | 📅 2025-02-27
...
* [**Certora Formal Verification of Openzeppelin contracts**](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/certora/README.md) ⭐ 27,253 | 🐛 358 | 🌐 Solidity | 📅 2026-09-23
